...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/TThinhLe/TestFramework'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'TThinhLe' => 'thinht.le@spiraledge.com' }
  s.source           = { :git => 'https://github.com/TThinhLe/TestFramework.git', :tag => s.version.to_s }
